...
class _LoginState extends State<Login> {
  ...
  getDate() async {
    await usersref
        .where("email", isEqualTo: myemail.replaceAll(' ', '',).toLowerCase())
        .get()
        .then((value) {
    ...
    if(prefs.getString('list') == null || prefs.getString('list')!.length == 0){
      print('i am in if ---------------------------------------');
      await prefs.clear();
      ...
      await prefs.setString('name', name[0]['username'] == null ? 'لا يوجد معلومات' : name[0]['username']);
      await prefs.setString('phone', name[0]['phone'] == null ? 'لا يوجد معلومات' : name[0]['phone']);
                  ...
                  content: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          child: Center(
                            child: Text("البريد الإلكتروني الذي أدخلته غير مرتبط بحساب" , textAlign: TextAlign.center , style: TextStyle(
                                fontFamily: "Abed"
                            ),),
                          ),
                        ),
                  ...
                  content: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          child: Center(
                            child: Text("كلمة المرور التي أدخلتها غير صحيحة ..." , textAlign: TextAlign.center , style: TextStyle(
                                fontFamily: "Abed"
                            ),),
                          ),
                        ),
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: GestureDetector(
                  onTap: () => {
                    Navigator.of(context).pushNamed("/rest")
                  },
                  child: Text(
                    "نسيت كلمة المرور ",
                    style: TextStyle(
